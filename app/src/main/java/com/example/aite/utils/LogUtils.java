    ...
    public static class Builder {
        public Builder() {
            ...
            if (Environment.MEDIA_MOUNTED.equals(Environment.getExternalStorageState())
                    && App.getContext().getApplicationContext().getExternalCacheDir() != null)
                defaultDir = App.getContext().getApplicationContext().getExternalCacheDir() + FILE_SEP + "log" + FILE_SEP;
            else {
                defaultDir = App.getContext().getApplicationContext().getCacheDir() + FILE_SEP + "log" + FILE_SEP;
            }
        }
