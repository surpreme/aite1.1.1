...
public class GoThingFragment extends BaseFragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.recy_layout, container, false);
        outed_house_recy = view.findViewById(R.id.outed_house_recy);
                ...
                .execute(new AbsCallback<BaseData<GothingBean.ListBean>>() {
                    ...
                    public BaseData<GothingBean.ListBean> convertResponse(okhttp3.Response response) throws Throwable {
                        ...
                        runOnUiThread(new Runnable() {
                            @Override
                            public void run() {
                                ThingAdapter recyAdapter = new ThingAdapter(getActivity(), gothingBean.getList(),null);
